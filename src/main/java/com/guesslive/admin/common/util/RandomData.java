...
public class RandomData {
    ...
    public static String getName(String[] args) {
        ...
        public static String getXingzuo(){
            String[] xingzuoList = { "处女座", "艺术爱好者", "科技爱好者", "自由职业", "演艺明星", "新手妈妈", "超级奶爸", "职业白领", "企业高管", "运动达人","全职太太","学生" };
            int a = (int) Math.abs(xingzuoList.length * Math.random());
            String xingzuo= xingzuoList[a];
            return xingzuo;
        }
